...
namespace DiffProcessor
{
	public class SortedLimitedList<T> where T : IComparable<T>
	{
        ...
        //one way linked list of deleted elements
		protected Entry freePool;
		protected Entry first;
		protected Entry last;

        //return first element from freePool
        ...
        //add element entry to beginning of list frePool
        ...
        //check if List is sorted by non-decreasing
        ...
        //delete element from list, element added to freePool
        ...
        //delete all elements from list and add them to freePool
		public void Clear()
		{
        ...
        //number aff add and remove operations
